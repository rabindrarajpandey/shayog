		...
		<div class="row rum-form">
			...
			<div class="col-md-8 col-sm-7 col-xs-12 rum-form-right">
				<div class="rum-right">
					...
					<form:form method="POST" commandName="instructor" action="success">
						<div class="form-group">
							<p> ${msg} </p>
							<p><form:input path="instructorId"  
								placeholder="instructor Id" />
								<form:errors path="instructorId" cssClass="error"></form:errors></p>
						</div>
					...
					<p>
						&nbsp;<a href="#">Forgot Password?</a>&nbsp;&nbsp;<a href="<c:url value="/"/>">Student Login</a>
					</p>

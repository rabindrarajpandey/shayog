...
<div class="c">
		<form:form method="POST" commandName="student" action="welcome">

			<table>
				<tr>
				<p>${userError} ${uniqueUserError} </p>
				<td>Student Id</td>
					<td><form:input path="studentId" placeholder="StudentId" /></td>
				...
				<tr>
					...
					<td><form:errors path="schoolName" cssClass="error" /></td>
				</tr>
				<tr>
				<tr>
					<td>CourseId</td>
					<td><form:input path="courseId" placeholder="couser Id"/></td><p> ${userError}</p>
					<td><form:errors path="courseId" cssClass="error"></form:errors>
				</tr>
			...
			<tr>
				...
				<tr>
					...
					<td>ZipCode</td>
					<td><form:input path="address.intZipCode" placeholder="StudentId" /></td><p>${userError}</p>
				...
				<tr>
					...
					<td><form:password path="confirmPassword" placeholder="retype password"/></td>
